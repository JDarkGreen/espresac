...
* SECCION APTITUDES
*----------------------------*/
add_settings_section( PREFIX."_themePage_section_aptitudes" , __( 'Personalizar Aptitudes:' , 'LANG' ), 'custom_settings_section_aptitudes_callback', 'customThemePageEmpresa' );

function custom_settings_section_aptitudes_callback() { 
	echo __( 'Coloca los campos correspondientes' , 'LANG' );  }


/* 
 * Misión De La Empresa
 */
add_settings_field( 'theme_mision_text', __( 'Misión de la Empresa:' , 'LANG' ), 'custom_mision_render', 'customThemePageEmpresa', PREFIX."_themePage_section_aptitudes" );
 ...
 */
add_settings_field( 'theme_vision_text', __( 'Visión de la Empresa:' , 'LANG' ), 'custom_vision_render', 'customThemePageEmpresa', PREFIX."_themePage_section_aptitudes" );
