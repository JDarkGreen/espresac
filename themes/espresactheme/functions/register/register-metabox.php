...
$path_product_price = realpath( dirname(dirname(__FILE__)) . '/metabox/product/mb_product_price.php' );
if( stream_resolve_include_path($path_product_price) )
	include($path_product_price);
