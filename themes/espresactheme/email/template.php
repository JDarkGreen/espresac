...
<?php  
	...
	$name_empresa  = "Espresac: Web";
	$link_web      = "http://www.espresac.com.pe/";
	$url_image     = "http://www.espresac.com.pe/wp-content/themes/espresactheme/assets/images/logo_espre_sac.png";
	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; font-family: 'Arial', sans-serif; border: 1px solid rgba(0,0,0,.4) ">
		...
		<tr>
			<td align="center" bgcolor="<?= $bg_header; ?>" style="padding: 20px 0 20px 0;">
				...
				<a href="<?= $link_web; ?>" target="_blank" style="display:inline-block; border: 1px solid rgba(255,255,255,.3); background: white;">
